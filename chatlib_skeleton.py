...
# Max size of total message
MAX_MSG_LENGTH = MSG_HEADER_LENGTH + MAX_DATA_LENGTH
# Delimiter character in protocol
DELIMITER = "|"
# Delimiter in the data part of the message
DATA_DELIMITER = "#"
...
def build_message(cmd, data):
    """
    Gets command name (str) and data field (str)
    and creates a valid protocol message
...
def join_data(msg_fields):
    """
    Helper method. Gets a list, joins all of it's fields to
    one string divided by the data delimiter.
